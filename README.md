...
- I also wanted to practice with using structs, and just like learning to use pointers during this project I found out how structs can make information accessible throughout the whole of a program.
